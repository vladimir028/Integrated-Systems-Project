...
namespace EshopWebApplication1.Migrations
{
    ...
    [Migration("20240902160923_petadoptioncenterdbsetadded")]
    partial class petadoptioncenterdbsetadded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eshop.DomainEntities.Domain.Activity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Eshop.DomainEntities.Order", b =>
                {
                    ...
                    b.Property<string>("EshopApplicationUserId1")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Eshop.DomainEntities.Domain.Activity", b =>
                {
                    b.HasOne("Eshop.DomainEntities.Domain.PlannedRoute", "PlannedRoute")
                        .WithMany("Activities")
            ...
            modelBuilder.Entity("Eshop.DomainEntities.Domain.Itinerary", b =>
                {
                    b.HasOne("Eshop.DomainEntities.TravelPackage", "TravelPackage")
                        .WithOne("Itinerary")
                        .HasForeignKey("Eshop.DomainEntities.Domain.Itinerary", "TravelPackageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Eshop.DomainEntities.Domain.PlannedRoute", b =>
                {
                    b.HasOne("Eshop.DomainEntities.Domain.Itinerary", "Itinerary")
            ...
            modelBuilder.Entity("Eshop.DomainEntities.Order", b =>
                {
                    b.HasOne("Eshop.DomainEntities.EshopApplicationUser", "EshopApplicationUser")
                        .WithMany()
                        .HasForeignKey("EshopApplicationUserId1");
            ...
            modelBuilder.Entity("Eshop.DomainEntities.TravelPackageInOrders", b =>
                {
                    b.HasOne("Eshop.DomainEntities.Order", "UserOrder")
                        .WithMany("TravelPackageInOrders")
            ...
            modelBuilder.Entity("Eshop.DomainEntities.TravelPackageInShoppingCart", b =>
                {
                    b.HasOne("Eshop.DomainEntities.ShoppingCart", "ShoppingCart")
                        .WithMany("TravelPackagesInShoppingCarts")
            ...
            modelBuilder.Entity("Eshop.DomainEntities.ShoppingCart", b =>
                {
                    b.Navigation("TravelPackagesInShoppingCarts");
                });
